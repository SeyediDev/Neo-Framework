...
public static class DependencyInjection
{
    public static IServiceCollection AddNeoOpenTelementry(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.Configure<TelemetryOptions>(configuration);
        _ = services.AddOpenTelemetry()
            .ConfigureResource(resource => resource
                .AddService(serviceName: openTelemetryOptions.ApplicationName, serviceVersion: openTelemetryOptions.ApplicationVersion))
            .WithTracing(tracing =>
            {
                _ = tracing
            ...
            {
                _ = metrics
                    .AddMeter(openTelemetryOptions.ApplicationName)
                    .AddAspNetCoreInstrumentation()
                    .AddHttpClientInstrumentation()

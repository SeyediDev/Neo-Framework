...
namespace Neo.Companion.DoctorCases.DirectRegistration;
...
public static class Setup
{
    public static ServiceProvider Build()
    {
        ...
        services.Configure<TelemetryOptions>(options => options.ApplicationName = "Neo.Doctor.DirectRegistration");
    ...
    public static ActivityListener Listen(Action<Activity> stopped)
    {
        ...
        {
            ShouldListenTo = source => source.Name == "Neo.Doctor.DirectRegistration",

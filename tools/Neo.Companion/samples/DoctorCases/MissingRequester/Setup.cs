...
namespace Neo.Companion.DoctorCases.MissingRequester;
...
public static class Setup
{
    public static ServiceProvider Build()
    {
        ...
        services.Configure<TelemetryOptions>(options => options.ApplicationName = "Neo.Doctor.MissingRequester");
    ...
    public static ActivityListener Listen(Action<Activity> stopped)
    {
        ...
        {
            ShouldListenTo = source => source.Name == "Neo.Doctor.MissingRequester",
